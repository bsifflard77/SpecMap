...
This project can use these skills:

1. **specmap-core** - Core workflow management
2. **specmap-documents** - Export to Word, Excel, PowerPoint, PDF
3. **specmap-agents** - Multi-agent orchestration
